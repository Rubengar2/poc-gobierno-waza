...
* **Versión:** `v1.2.0`
* **Propietario:** `platform.governance1@enterprise.com`
* **Modelo Evaluador:** `gpt-4o-mini`
* **Fecha de Evaluación:** `2026-08-14 21:22:34 UTC`
* **Commit Hash:** `2691693`
...
* **Score Integrado:** **79.15%** / 100.00% *(Umbral: 75.0%)*

### Desglose por Eje

| Eje de Gobierno | Puntuación | Porcentaje | Estado |
| :--- | :---: | :---: | :---: |
| 🛡️ **Seguridad** | `33.25 / 40.00` | `83.1%` | 🟢 |
| ⚙️ **Calidad** | `27.00 / 40.00` | `67.5%` | 🟡 |
| 💰 **Economía** | `18.90 / 20.00` | `94.5%` | 🟢 |
